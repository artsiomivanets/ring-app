...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__27723_SHARP_){
return parseInt(p1__27723_SHARP_);
}),cljs.core.take.call(null,(3),clojure.string.split.call(null,v,/[^\d]/)))));
}catch (e27724){if((e27724 instanceof Error)){
var e = e27724;
...
var c_27726 = (new goog.debug.Console());
var G__27725_27727 = c_27726.getFormatter();
goog.object.set(G__27725_27727,"showAbsoluteTime",false);

goog.object.set(G__27725_27727,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_27726);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__27728_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__27728_SHARP_);
...
var temp__5733__auto__ = cljs.core.get.call(null,figwheel.repl.logging.log_levels,level);
