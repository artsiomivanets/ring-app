...
var o25881 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25881["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25882 = temp__5733__auto____$1;
return (o25882["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21648__auto__ = f;
return (o__21648__auto__["toString"]).call(o__21648__auto__);
} else {
return "";
}
}catch (e25883){var _ = e25883;
return "";
}});
...
try{var o__21648__auto___25885 = t;
(o__21648__auto___25885["cljs$lang$ctorPrWriter"]).call(o__21648__auto___25885,t,writer);
}catch (e25884){var __25886 = e25884;
}
...
var char_code = (function (){var o__21648__auto__ = (new String(char$));
return (o__21648__auto__["charCodeAt"]).call(o__21648__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21648__auto__ = String;
return (o__21648__auto__["fromCharCode"]).call(o__21648__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25887 = num_code;
switch (G__25887) {
case (1):
return (185);
...
var o__21648__auto__ = String;
return (o__21648__auto__["fromCharCode"]).call(o__21648__auto__,superscript_code);
});
/**
...
}catch (e25889){var _e__21655__auto__ = e25889;
return false;
}})())){
...
var vec__25890 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25890,(0),null);
...
var or__4126__auto__ = (function (){var temp__5733__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5733__auto__)){
...
if(cljs.core.truth_(temp__5733__auto__)){
var o25893 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25893["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25894 = temp__5733__auto____$1;
return (o25894["nameToPath"]);
} else {
return null;
}
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___25902]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25897){
var vec__25898 = p__25897;
var ns_detector = cljs.core.nth.call(null,vec__25898,(0),null);
...
var G__25904 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25905 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25904;
remaining_tokens = G__25905;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25895){
var G__25896 = cljs.core.first.call(null,seq25895);
var seq25895__$1 = cljs.core.next.call(null,seq25895);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25896,seq25895__$1);
}));
...
var vec__25909 = cljs.core.split_with.call(null,(function (p1__25908_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25908_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25909,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25909,(1),null);
...
var vec__25915 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25915,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25915,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25918 = cljs.core.rest.call(null,remaining_tokens);
var G__25919 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25918;
name_tokens = G__25919;
continue;
} else {
...
var vec__25922 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25922,(0),null);
var arity = cljs.core.nth.call(null,vec__25922,(1),null);
var vec__25925 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25925,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25925,(1),null);
var vec__25928 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25928,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25928,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25928,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25928,(3),null);
...
var vec__25934 = result;
var munged_ns = cljs.core.nth.call(null,vec__25934,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25934,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25934,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25934,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25934,(4),null);
var arity = cljs.core.nth.call(null,vec__25934,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__25938 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__25938,(0),null);
var args = cljs.core.nth.call(null,vec__25938,(1),null);
var vec__25941 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25941,(0),null);
var name = cljs.core.nth.call(null,vec__25941,(1),null);
...
var G__25944 = (arity + (1));
var G__25945 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25946){
var vec__25947 = p__25946;
var arity = cljs.core.nth.call(null,vec__25947,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25947,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25950_SHARP_){
return cljs.core.get.call(null,arities,p1__25950_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25951_SHARP_){
return cljs.core.drop.call(null,(2),p1__25951_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___25958 = arguments.length;
var i__4737__auto___25959 = (0);
while(true){
if((i__4737__auto___25959 < len__4736__auto___25958)){
args__4742__auto__.push((arguments[i__4737__auto___25959]));

var G__25960 = (i__4737__auto___25959 + (1));
i__4737__auto___25959 = G__25960;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25954){
var vec__25955 = p__25954;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25955,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25952){
var G__25953 = cljs.core.first.call(null,seq25952);
var seq25952__$1 = cljs.core.next.call(null,seq25952);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25953,seq25952__$1);
}));
...
var map__25963 = options;
var map__25963__$1 = (((((!((map__25963 == null))))?(((((map__25963.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25963.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25963):map__25963);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25963__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25963__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25963__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25963__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25964 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25964,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25964,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25964,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25964,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25964,(4),null);
var arity = cljs.core.nth.call(null,vec__25964,(5),null);
...
var o__21648__auto__ = f;
return (o__21648__auto__["getBasis"]).call(o__21648__auto__);
});
/**
...
}catch (e25968){var _e__21655__auto__ = e25968;
...
var G__25969 = (obj[cljs.core.first.call(null,path)]);
var G__25970 = cljs.core.rest.call(null,path);
obj = G__25969;
path = G__25970;
continue;
} else {
...
var _STAR_ = (function (accum,p__25971){
var vec__25972 = p__25971;
var bit = cljs.core.nth.call(null,vec__25972,(0),null);
var protocol = cljs.core.nth.call(null,vec__25972,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25975){
var vec__25976 = p__25975;
var ns = cljs.core.nth.call(null,vec__25976,(0),null);
var name = cljs.core.nth.call(null,vec__25976,(1),null);
var selector = cljs.core.nth.call(null,vec__25976,(2),null);
...
var post_process = (function (p__25980){
var vec__25981 = p__25980;
var munged_name = cljs.core.nth.call(null,vec__25981,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25981,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25979_SHARP_){
return (obj[cljs.core.first.call(null,p1__25979_SHARP_)]);
}),sorted_matches);
