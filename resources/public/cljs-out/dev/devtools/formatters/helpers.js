...
var G__25986 = devtools.prefs.pref.call(null,v);
v = G__25986;
continue;
} else {
return v;
...
}catch (e25989){var _e__21655__auto__ = e25989;
return false;
}})();
...
}catch (e25993){var _e__21655__auto__ = e25993;
return false;
}})();
...
}catch (e25995){var _e__21655__auto__ = e25995;
return false;
}}
}
});
...
var vec__25997 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25997,(0),null);
var name = cljs.core.nth.call(null,vec__25997,(1),null);
...
return cljs.core.some.call(null,(function (p1__26000_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26000_SHARP_);
}),template);
});
